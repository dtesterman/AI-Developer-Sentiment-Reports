#!/usr/bin/env python3
"""Generate analysis-report-2026-07-06.html from the markdown report."""
import re
import sys
import subprocess
try:
...
SRC_MD = OUTDIR / 'analysis-report-2026-07-06.md'
DST_HTML = OUTDIR / 'analysis-report-2026-07-06.html'
TEMPLATE_HTML = OUTDIR / 'analysis-report-2026-06-29.html'
...
<div class="subtitle">Extraction 16 &nbsp;&nbsp;June 22 &ndash; June 29, 2026<br>Analysis executed 2026-07-06</div>
...
def main():
    ...
    footer = '''<footer>
<p>AI Dev Sentiment Analysis &mdash; Extraction 16 &mdash; Generated 2026-07-06</p>

#!/usr/bin/env python3
"""Generate longitudinal-summary-2026-06-22.html from MD via blue-accent template."""
...
SRC_MD = OUTDIR / 'longitudinal-summary-2026-06-22.md'
DST_HTML = OUTDIR / 'longitudinal-summary-2026-06-22.html'
...
<p>Longitudinal Engine v1.3 &middot; Domain Config v1.2 &middot; Bootloader v1.9 &middot; HTML Engine v1.2 (blue accent)</p>
    ...
    head = re.sub(
        ...
        '<meta property="og:title" content="Longitudinal Trend Report — E1 - E12 (2026-03-20 to 2026-06-22)">',
        head,
    )
    head = re.sub(
    ...
    head = re.sub(
        r'<title>.*?</title>',
        '<title>Longitudinal Trend Report — E1 - E12 (2026-03-20 to 2026-06-22)</title>',
        head,
    )
    html = f'''{head}
<body>

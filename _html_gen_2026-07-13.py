#!/usr/bin/env python3
"""Generate analysis-report-2026-07-13.html from the markdown report."""
...
SRC_MD = OUTDIR / 'analysis-report-2026-07-13.md'
DST_HTML = OUTDIR / 'analysis-report-2026-07-13.html'
TEMPLATE_HTML = OUTDIR / 'analysis-report-2026-07-06.html'
...
<div class="subtitle">Extraction 18 &nbsp;&nbsp;July 6 &ndash; July 13, 2026<br>Analysis executed 2026-07-13</div>
...
def main():
    ...
    stats = {
        "items": "72",
        "dominant": "30% Caut. Pos.",
        "top_cluster": "Tool-Specific Issues",
        "incidents": "5",
        "patterns": "8",
        "batches": "10/10",
    }
    ...
    footer = '''<footer>
<p>AI Dev Sentiment Analysis &mdash; Extraction 18 &mdash; Generated 2026-07-13</p>
<p>Analysis Engine v1.17 &middot; Domain Config v1.2 &middot; Bootloader v1.9 &middot; HTML Engine v1.2</p>
</footer>'''
    head = re.sub(r'<meta name="description" content="[^"]*">',
        '<meta name="description" content="AI Dev Sentiment Analysis &mdash; July 6 to July 13, 2026 (E18, n=72). Commerce-Department deal\'s safety-classifier friction becomes strongest new practitioner signal; three frontier coding models GA in ten days; GhostApproval + HalluSquatting attack classes disclose; Anthropic-trust-arc compounds with Claude Code steganography; Fable-as-advisor + Sonnet-5-executor pattern gets vendor blessing.">', head)
    head = re.sub(r'<meta property="og:title" content="[^"]*">',
        '<meta property="og:title" content="AI Dev Sentiment Analysis &mdash; E18 (July 6 &ndash; July 13, 2026)">', head)
    head = re.sub(r'<meta property="og:description" content="[^"]*">',
        '<meta property="og:description" content="Commerce-Department deal safety-classifier friction; three frontier coding models GA in ten days; GhostApproval + HalluSquatting attack classes; vendor-blessed Fable-as-advisor pattern; anthropic-trust-arc compounds.">', head)
    head = re.sub(r'<title>.*?</title>',
        '<title>AI Dev Sentiment Analysis &mdash; E18 (July 6 &ndash; July 13, 2026)</title>', head)
    html = f'''{head}
<body>
{nav}
<div class="wrapper">
